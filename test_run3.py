...
print "in ==============="
sample_df = pd.read_csv('/home/elucidata/work_station/corna/isocorrect_shef/Raw_intensity_file.csv')
print(sample_df.head())
print "\nmetadata mq"
metadata_df = pd.read_csv('/home/elucidata/work_station/corna/isocorrect_shef/metadata_mq_file.csv')
print(metadata_df.head())
print "\n metadata sample file"
metadata_sample = pd.read_csv('/home/elucidata/work_station/corna/isocorrect_shef/sample_metadata.csv')
...
frac_enr_df.to_csv("frac_enr_bitbucket.csv")
